...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *  +---------------------------------------+           +----------------------------------------------+ +-----+
     *  |CTL_ESC  |  A  |  S  |  D  |  F  |  G  |           |  H  |  J  |  K  |  L  |  ;  |  '  |  ENTER   | |PGDN |
     * +------------------------------------------+     +-----+--------------------------------------------+ +-----+
     * |LSHFT       |  Z  |  X  |  C  |  V  |  B  |     | DEL |  N  |  M  |  ,  |  .  |  /  | RSHFT  | +-----+
     * +---------------------------------------------+  +--------------------------------------------+ | UP  |    
     * |LCTRL |          |L_GUI |     SPC     |L_ALT |  |     SPC      | FN1     |               +-----------------+
     * +------+          +---------------------------+  +------------------------+               |LEFT |DOWN |RIGHT|
     *                                                                                           +-----------------+
     */

    [0] = LAYOUT( /* Base */
            TD(TD_ESC_GRV), KC_1,    KC_2,   KC_3,    KC_4,   KC_5,  KC_6,                         KC_7,    KC_8,      KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,      KC_HOME,
            ...
            KC_LCTL,                 KC_LGUI,         KC_SPC, KC_LALT,           KC_SPC,                    MO(1),                           KC_LEFT, KC_DOWN, KC_RIGHT
          ),
